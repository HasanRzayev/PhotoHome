...
namespace PhotoHome.Controllers
{
	public class UserController : Controller
	{
		...
		public IActionResult Created()
		{
			...
			ViewBag.Images = model; // burda images yazilmisdi sehv idi Images eledim arxada tapmirdi ona gore
		...
		public IActionResult Liked()
		{
			...
			var image_list = new List<Picture>(); // list picture eledim ki tite gelsin

			foreach (var item in model)
			{
				image_list.Add(_base.Images.First(a => a.Id == item.Image_Id)); // burda da imageurl yox ele ozunu qaytardim
			}
