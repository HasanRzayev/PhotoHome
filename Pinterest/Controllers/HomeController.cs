...
namespace PhotoHome.Controllers
{
	...
	public class HomeController : Controller
	{
		...
		public void UploadImage(string imagePath, AddImageViewModel viewModel)
		{
			try
			{
				...
				Picture _image = new()
				{
					...
					catagory_id = viewModel.catagory_id,
		...
		{
			if((viewModel.ImageUrl.Length / (1024 * 1024)) >= 10)
			{
				return RedirectToAction("Create");
			}

			var path = await UploadFileHelper.UploadFile(viewModel.ImageUrl);
			...
			UploadImage(imagePath, viewModel);
